...
class InferenceService(object):
    ...
    def inference(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ai_flow.InferenceService/inference',
            service__pb2.RecordRequest.SerializeToString,
            service__pb2.RecordResponse.FromString,
